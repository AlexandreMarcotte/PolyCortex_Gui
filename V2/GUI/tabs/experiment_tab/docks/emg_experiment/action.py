...
class Action(pg.TextItem):
    ...
    def init_action(self):
        self._html = self._set_html(14, self.actn_txt, self.color, self.wait_txt)
    ...
    def activate_html(self):
        """Change the color  and text of the action text to indicate it's
           activation"""
        self.html = self._set_html(16, self.actn_txt, color='#0FF', wait_txt='NOW!')
        self.setHtml(self.html)

    def _set_html(self, txt_size, actn_txt, color, wait_txt):
