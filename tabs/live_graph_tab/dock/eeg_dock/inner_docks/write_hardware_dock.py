...
class WriteHardwareDock:
    ...
    def create_layout(self):
        write_hardware_d = InnerDock(
            self.eeg_dock.layout, 'Write to hardware', b_pos=(0, 4),
        ...
        self.eeg_dock.dock_area.addDock(write_hardware_d.dock)
    ...
    def send_byte_to_hardware(self):
        ...
        try:
            for b in byte_settings:
                self.eeg_dock.stream_source.board.ser_write(b.encode())
                sleep(0.01)
